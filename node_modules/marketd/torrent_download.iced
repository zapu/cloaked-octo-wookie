...
AnnounceAddress = 'http://pi.zapu.net:8081/announce'
TorrentClient = null
...
module.exports.initTracker = () ->
	...
	TorrentClient = new node_torrent logLevel: 'INFO'
...
module.exports.makeTorrentFromProgram = (db, doc, response) ->
	...
	fileStream = fs.createWriteStream path.join programDirPath, 'program.ova'
	...
	await nt.makeWrite torrentFilePath, 
		AnnounceAddress,  programDirPath, ['program.ova'], 
		defer err, torrent
